    ...
    <>
      ...
      <main className="container mx-auto py-12 px-4">
        <div class="container mx-auto">
          ...
          <p>Pentru localitățile în care nu există un punct de lucru se va adăuga un cost suplimentar de 15 lei reprezentand serviciul – home delivery. &nbsp;Costul final va fi comunicat de către un reprezentant de vânzari WaWa Content.</p>
          ...
          <p>Termenul de livrare poate suferi întarzieri, în situațiile apărute independent de participarea WaWa Content SRL sau a societății de curierat cum ar fi: condiții meteorologice nefavorabile, accidente sau blocaje rutiere. În toate aceste cazuri, un reprezentant al departamentului de vânzări vă va comunica o nouă dată privind efectuarea livrarii.</p>
          <p>&nbsp;</p>
        </div>
      </main>
      <SiteFooter />
